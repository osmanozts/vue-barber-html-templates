    ...
    <div class="container infoWrapper pb-15">
      <v-row>
        <v-col cols="12" md="3" xs="12" class="my-3">
          <div class="d-flex">
            <v-icon xLarge color="#9E49A4" class="ficon" size="40">mdi-map-marker</v-icon>
            <div>
        ...
        <v-col cols="12" md="3" xs="12" class="my-3">
          <div class="d-flex">
            <v-icon large color="#9E49A4" class="ficon">mdi-clock-time-eight</v-icon>
            <div>
        ...
        <v-col cols="12" md="3" xs="12" class="my-3">
          <div class="d-flex">
            <v-icon xLarge color="#9E49A4" class="ficon" size="40">mdi-email</v-icon>
            <div>
        ...
        <v-col cols="12" md="3" xs="12" class="my-3">
          <div class="d-flex">
            <v-icon xLarge color="#9E49A4" class="ficon" size="40">mdi-phone</v-icon>
            <div>
              <h4 class="title">Telefonnummer:</h4>
              <p class="subTitle">+49 1111 111111</p>
            </div>
          </div>
        </v-col>
      </v-row>
...
.infoWrapper {
  box-shadow: 0px 2px 15px rgba(0, 0, 0, 0.39);
  padding: 30px;
  /* background: #eee; */
}
