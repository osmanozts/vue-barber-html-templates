    ...
    <div class="container infoWrapper pb-15">
      <v-row>
        <v-col cols="12" md="3" xs="12" class="my-3">
          <div class="d-flex">
            <v-icon xLarge color="#b23850" class="ficon" size="40">mdi-map-marker</v-icon>
            <div>
        ...
        <v-col cols="12" md="3" xs="12" class="my-3">
          <div class="d-flex">
            <v-icon large color="#b23850" class="ficon">mdi-clock-time-eight</v-icon>
            <div>
        ...
        <v-col cols="12" md="3" xs="12" class="my-3">
          <div class="d-flex">
            <v-icon xLarge color="#b23850" class="ficon" size="40">mdi-email</v-icon>
            <div>
        ...
        <v-col cols="12" md="3" xs="12" class="my-3">
          <div class="d-flex">
            <v-icon xLarge color="#b23850" class="ficon" size="40">mdi-phone</v-icon>
            <div>
