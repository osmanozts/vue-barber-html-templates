<template>
  <div>
    <div class="serviceSection">
      ...
      <splide
        class="serviceRow"
        :options="windowWidth > 950 ? options : optionsHandy"
        has-slider-wrapper
      >
        <splide-slide v-for="(item,i) in services" :key="i" class="columnContainer">
          <div
            :class="{serviceBox : windowWidth > 950 ,serviceBoxHandy  :windowWidth<950}"
